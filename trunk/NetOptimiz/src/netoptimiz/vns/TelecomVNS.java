 ...
 private Arc monArc;
  ...
  public void faireMvt (Graphe g) {
        ...
        // on sauvegarde pour la fonction de retour
         if (monArc.getCapacite()==0) monArc.setCapacite(capaciteInitiale); //***modif fab : capacite initiale
         ...
         while (c<=K )
            ...
            //  puis on fait le delta cout pour savoir si la solution est meilleure
                     ...
                     if (coutInitial>cout) {
                         ...
                         else coutInitial=cout; // il faut mettre à jour le cout initial
                     }
                 }
               c++;
            }
  ...
  //  Graphe tempGraphe = g.clone();
        ...
        // On appelle la fonction de vérification des demandes
            ...
            for (Arc b : g.getarcs()) {
                ...
                if (b.getCapacite()!=0) gJung.addEdge(b,b.getNoeudOrigine(), b.getNoeudExtremite());
            }
